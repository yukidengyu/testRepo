> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [zhuanlan.zhihu.com](https://zhuanlan.zhihu.com/p/276461821)

给大家推荐本我自己写的电子书《PyCharm 中文指南》，把各种 PyCharm 的高效的使用技巧用 GIF 动态图的形式展示出来。有兴趣的可以看它的在线文档：

[PyCharm 中文指南 2.0 文档](http://pycharm.iswbm.com)
...
*   源码安装：在 [https://pypi.org/project/setuptools/#files](https://pypi.org/project/setuptools/#files) 中下载 zip 包 解压执行 `python setup.py install` 安装
...
![](https://pic1.zhimg.com/v2-dffd77a245997a841eb426d9c0ce5184_r.jpg)
...
![](https://pic4.zhimg.com/v2-b0a22d8b82eac1f25bc6a1b95f6e0c2f_r.jpg)
...
`pbr` 是 setuptools 的辅助工具，最初是为 OpenStack 开发 ([https://launchpad.net/pbr)，基于 `d2to1`。](https://launchpad.net/pbr)%EF%BC%8C%E5%9F%BA%E4%BA%8E%60d2to1%60%E3%80%82)
...
1.  long_description。从 README.rst, README.txt or README file 中生成`long_description`参数
...
![](https://pic2.zhimg.com/v2-7416d2c5ffd4fde928d7bd214ea59d39_r.jpg)
...
或者也可以使用 `twine` 工具注册上传，它是一个专门用于与 pypi 进行交互的工具，详情可以参考官网：[https://www.ctolib.com/twine.html，这里不详细讲了。](https://www.ctolib.com/twine.html%EF%BC%8C%E8%BF%99%E9%87%8C%E4%B8%8D%E8%AF%A6%E7%BB%86%E8%AE%B2%E4%BA%86%E3%80%82)
